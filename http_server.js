...
// ------------------------------------------------------------------
// This is to connect all of this to the index.html file
...
app.get('/data', function(req, res){     
    ...
    res.send(db.get('users').value()); // this is simply to see all the posts, will show up on localhost:3000/data, this is basically a read
